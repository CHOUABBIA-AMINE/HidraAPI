 ...
 *
 * @Name        : RevokeRoleFromUserUseCase
 ...
 *
 * @Description : Inbound use-case port for revoking a role from an identity user.
 *
 */
    package dz.sh.hidra.modules.identity.application.port.in;
...
import dz.sh.hidra.modules.identity.application.dto.UserDto;
    ...
    /**
     * Inbound use-case port for revoking an identity role from a user.
     *
     * <p>Business role: exposes the application boundary for revoking an identity role from a user in the identity
     * module.</p>
     *
    ...
    public interface RevokeRoleFromUserUseCase {
        ...
        UserDto revokeRoleFromUser(RevokeRoleFromUserCommand command);
    }
