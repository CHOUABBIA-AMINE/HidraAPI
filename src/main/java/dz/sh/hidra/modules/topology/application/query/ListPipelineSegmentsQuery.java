 ...
 *
 * @Name        : ListPipelineSegmentsQuery
 ...
 *
 * @Description : Application query for listing pipeline segments.
 *
 */
package dz.sh.hidra.modules.topology.application.query;
...
/**
 * Carries input required to list pipeline segments.
 *
 * <p>Business role:
 ...
 */
public record ListPipelineSegmentsQuery(
        String searchText,
    ...
    public ListPipelineSegmentsQuery {
     ...
     * @return list query
     */
    public static ListPipelineSegmentsQuery all(PageRequest pageRequest) {
        return new ListPipelineSegmentsQuery(null, null, null, null, null, pageRequest);
    }
