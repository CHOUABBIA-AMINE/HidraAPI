 ...
 *
 * @Name        : JpaExternalIdentityRepositoryAdapter
 ...
 *
 * @Description : Database-backed repository adapter for ExternalIdentity.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.adapter;

import dz.sh.hidra.modules.identity.application.port.out.ExternalIdentityRepositoryPort;
...
/**
 * Database-backed repository adapter for ExternalIdentity.
 */
@Component
public class JpaExternalIdentityRepositoryAdapter implements ExternalIdentityRepositoryPort {

    private final ExternalIdentityJpaRepository repository;

    public JpaExternalIdentityRepositoryAdapter(ExternalIdentityJpaRepository repository) {
        this.repository = Objects.requireNonNull(repository, "ExternalIdentityJpaRepository must not be null.");
    }

    @Override
    public ExternalIdentity save(ExternalIdentity model) {
