 ...
 *
 * @Description : Inbound port for a pipeline system creation.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for a pipeline system creation.
 *
 * <p>Business role:
 ...
 */
public interface CreatePipelineSystemUseCase {

    /**
     * Creates a pipeline system.
     *
     * @param command use-case input
     * @return created a pipeline system DTO
     */
    PipelineSystemDto createPipelineSystem(CreatePipelineSystemCommand command);
}
