 ...
 *
 * @Description : Framework-neutral persistence shape for UserPermissionGrant.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for UserPermissionGrant.
 *
 ...
 */
public record UserPermissionGrantJpaEntity(
        String id,
        String payload
) {
}
