 ...
 *
 * <p>Business role:
 * This mapper translates HTTP contracts and resolves multilingual topology type catalog references.
 *
 * <p>Architecture role:
 * This API-layer mapper depends only on application inbound ports and application DTOs. It does not
 * access repositories, persistence entities, identity implementation, organization implementation,
 * measurement, flow, risk, workflow, or platform infrastructure.
 *
 * <p>Validation:
 * Bean Validation validates raw REST inputs before mapping. Catalog type codes are resolved through
 * ResolveTopologyCatalogTypeUseCase so commands receive real catalog identifiers, not raw enum-like
 * strings.
 */
public final class TopologyRestMapper {
    ...
    public TopologyRestMapper(ResolveTopologyCatalogTypeUseCase resolveTopologyCatalogTypeUseCase) {
        this.resolveTopologyCatalogTypeUseCase = Objects.requireNonNull(
                resolveTopologyCatalogTypeUseCase,
                "Resolve topology catalog type use case must not be null.");
    }

    /**
     * Transitional constructor kept for tests that instantiate the mapper directly before COR-014.
     */
    ...
    public CreatePipelineSystemCommand toCommand(CreatePipelineSystemRequest request) {
        return toCommand(request, DEFAULT_LOCALE);
    }
    ...
    public CreateFacilityCommand toCommand(CreateFacilityRequest request, String acceptLanguage) {
        ...
        return new CreateFacilityCommand(
                TopologyCode.of(request.code()),
                TopologyName.of(request.name()),
                facilityTypeReferenceForCreation(request.facilityTypeCode(), locale),
                productTypeReferenceForCreation(request.productTypeCode(), locale),
    ...
    public CreateTopologyNodeCommand toCommand(CreateTopologyNodeRequest request, String acceptLanguage) {
        ...
        return new CreateTopologyNodeCommand(
                TopologyCode.of(request.code()),
                TopologyName.of(request.name()),
                nodeTypeReferenceForCreation(request.nodeTypeCode(), locale),
    ...
    public CreatePipelineAppurtenanceCommand toCommand(CreatePipelineAppurtenanceRequest request, String acceptLanguage) {
        ...
        return new CreatePipelineAppurtenanceCommand(
                ...
                TopologyCode.of(request.code()),
                TopologyName.of(request.name()),
                appurtenanceTypeReferenceForCreation(request.appurtenanceTypeCode(), locale),
                optionalValveTypeReferenceForCreation(request.valveTypeCode(), locale),
    ...
    public CreateTopologyConnectionCommand toCommand(CreateTopologyConnectionRequest request, String acceptLanguage) {
        ...
        return new CreateTopologyConnectionCommand(
                ...
                TopologyNodeId.of(request.fromNodeId()),
                TopologyNodeId.of(request.toNodeId()),
                connectionTypeReferenceForCreation(request.connectionTypeCode(), locale),
    ...
    public RegisterEquipmentCommand toCommand(RegisterEquipmentRequest request, String acceptLanguage) {
        ...
        return new RegisterEquipmentCommand(
                TopologyCode.of(request.code()),
                TopologyName.of(request.name()),
                equipmentTypeReferenceForCreation(request.equipmentTypeCode(), locale),
    ...
    public ListPipelineSystemsQuery toListPipelineSystemsQuery(
        ...
        return toListPipelineSystemsQuery(searchText, productTypeCode, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListPipelineSystemsQuery toListPipelineSystemsQuery(
        ...
        return new ListPipelineSystemsQuery(
                searchText,
                optionalProductType(productTypeCode, locale),
    ...
    public ListPipelinesQuery toListPipelinesQuery(
        ...
        return toListPipelinesQuery(searchText, pipelineSystemId, productTypeCode, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListFacilitiesQuery toListFacilitiesQuery(
        ...
        return toListFacilitiesQuery(searchText, facilityTypeCode, productTypeCode, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListFacilitiesQuery toListFacilitiesQuery(
        ...
        return new ListFacilitiesQuery(
                searchText,
                optionalFacilityType(facilityTypeCode, locale),
                optionalProductType(productTypeCode, locale),
                optionalTopologyStatus(status),
                PageRequest.of(page, size));
    }
    ...
    public ListTopologyNodesQuery toListTopologyNodesQuery(
        ...
        return toListTopologyNodesQuery(searchText, nodeTypeCode, facilityId, pipelineAppurtenanceId, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListTopologyNodesQuery toListTopologyNodesQuery(
        ...
        return new ListTopologyNodesQuery(
                searchText,
                optionalNodeType(nodeTypeCode, locale),
    ...
    public ListPipelineAppurtenancesQuery toListPipelineAppurtenancesQuery(
        ...
        return toListPipelineAppurtenancesQuery(searchText, pipelineId, appurtenanceTypeCode, valveTypeCode, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListPipelineAppurtenancesQuery toListPipelineAppurtenancesQuery(
        ...
        return new ListPipelineAppurtenancesQuery(
                searchText,
                optionalPipelineId(pipelineId),
                optionalPipelineAppurtenanceType(appurtenanceTypeCode, locale),
                optionalValveType(valveTypeCode, locale),
                optionalTopologyStatus(status),
                PageRequest.of(page, size));
    }
    ...
    public ListTopologyConnectionsQuery toListTopologyConnectionsQuery(
        ...
        return toListTopologyConnectionsQuery(searchText, fromNodeId, toNodeId, connectionTypeCode, linkedAssetType, status, page, size, DEFAULT_LOCALE);
    }
    ...
    public ListTopologyConnectionsQuery toListTopologyConnectionsQuery(
        ...
        return new ListTopologyConnectionsQuery(
                ...
                optionalTopologyNodeId(fromNodeId),
                optionalTopologyNodeId(toNodeId),
                optionalConnectionType(connectionTypeCode, locale),
    ...
    public PipelineSystemResponse toResponse(PipelineSystemDto dto) {
        return toResponse(dto, DEFAULT_LOCALE);
    }
    ...
    public PipelineSystemResponse toResponse(PipelineSystemDto dto, String acceptLanguage) {
        ...
        return new PipelineSystemResponse(
                ...
                dto.name(),
                dto.description(),
                toTypeResponse(PRODUCT_TYPE, dto.productType(), locale),
                dto.status(),
    ...
    public FacilityResponse toResponse(FacilityDto dto, String acceptLanguage) {
        ...
        return new FacilityResponse(
                ...
                dto.code(),
                dto.name(),
                toTypeResponse(FACILITY_TYPE, dto.facilityType(), locale),
                toTypeResponse(PRODUCT_TYPE, dto.productType(), locale),
                dto.status(),
    ...
    public TopologyNodeResponse toResponse(TopologyNodeDto dto, String acceptLanguage) {
        ...
        return new TopologyNodeResponse(
                ...
                dto.code(),
                dto.name(),
                toTypeResponse(NODE_TYPE, dto.nodeType(), locale),
                dto.facilityId(),
    ...
    public PipelineAppurtenanceResponse toResponse(PipelineAppurtenanceDto dto, String acceptLanguage) {
        ...
        return new PipelineAppurtenanceResponse(
                ...
                dto.code(),
                dto.name(),
                toTypeResponse(APPURTENANCE_TYPE, dto.appurtenanceType(), locale),
                toOptionalTypeResponse(VALVE_TYPE, dto.valveType(), locale),
    ...
    public TopologyConnectionResponse toResponse(TopologyConnectionDto dto, String acceptLanguage) {
        ...
        return new TopologyConnectionResponse(
                ...
                dto.fromNodeId(),
                dto.toNodeId(),
                toTypeResponse(CONNECTION_TYPE, dto.connectionType(), locale),
                dto.linkedAssetType(),
                dto.linkedAssetId(),
                dto.status(),
                dto.createdAt(),
    ...
    public EquipmentResponse toResponse(EquipmentDto dto, String acceptLanguage) {
        ...
        return new EquipmentResponse(
                ...
                dto.code(),
                dto.name(),
                toTypeResponse(EQUIPMENT_TYPE, dto.equipmentType(), locale),
                dto.parentAssetType(),
                dto.parentAssetId(),
                dto.status(),
                dto.createdAt(),
    ...
    public PageResult<PipelineSystemResponse> toPipelineSystemResponsePage(PageResult<PipelineSystemDto> pageResult) {
        return toPipelineSystemResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    public PageResult<PipelineSystemResponse> toPipelineSystemResponsePage(PageResult<PipelineSystemDto> pageResult, String acceptLanguage) {
        ...
        return PageResult.of(
                pageResult.items().stream().map(dto -> toResponse(dto, acceptLanguage)).toList(),
                pageResult.page(),
                pageResult.size(),
    ...
    public PageResult<PipelineResponse> toPipelineResponsePage(PageResult<PipelineDto> pageResult) {
        return toPipelineResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    public PageResult<FacilityResponse> toFacilityResponsePage(PageResult<FacilityDto> pageResult) {
        return toFacilityResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    public PageResult<TopologyNodeResponse> toTopologyNodeResponsePage(PageResult<TopologyNodeDto> pageResult) {
        return toTopologyNodeResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    public PageResult<PipelineAppurtenanceResponse> toPipelineAppurtenanceResponsePage(PageResult<PipelineAppurtenanceDto> pageResult) {
        return toPipelineAppurtenanceResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    public PageResult<TopologyConnectionResponse> toTopologyConnectionResponsePage(PageResult<TopologyConnectionDto> pageResult) {
        return toTopologyConnectionResponsePage(pageResult, DEFAULT_LOCALE);
    }
    ...
    private ProductTypeReference productTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(PRODUCT_TYPE, code, locale);
        return ProductTypeReference.of(dto.id(), dto.code());
    }

    private ProductTypeReference optionalProductType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(PRODUCT_TYPE, code, locale);
        return ProductTypeReference.of(dto.id(), dto.code());
    }

    private FacilityTypeReference facilityTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(FACILITY_TYPE, code, locale);
        return FacilityTypeReference.of(dto.id(), dto.code());
    }

    private FacilityTypeReference optionalFacilityType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(FACILITY_TYPE, code, locale);
        return FacilityTypeReference.of(dto.id(), dto.code());
    }

    private NodeTypeReference nodeTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(NODE_TYPE, code, locale);
        return NodeTypeReference.of(dto.id(), dto.code());
    }

    private NodeTypeReference optionalNodeType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(NODE_TYPE, code, locale);
        return NodeTypeReference.of(dto.id(), dto.code());
    }

    private PipelineAppurtenanceTypeReference appurtenanceTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(APPURTENANCE_TYPE, code, locale);
        return PipelineAppurtenanceTypeReference.of(dto.id(), dto.code());
    }

    private PipelineAppurtenanceTypeReference optionalPipelineAppurtenanceType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(APPURTENANCE_TYPE, code, locale);
        return PipelineAppurtenanceTypeReference.of(dto.id(), dto.code());
    }

    private ValveTypeReference optionalValveTypeReferenceForCreation(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForCreation(VALVE_TYPE, code, locale);
        return ValveTypeReference.of(dto.id(), dto.code());
    }

    private ValveTypeReference optionalValveType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(VALVE_TYPE, code, locale);
        return ValveTypeReference.of(dto.id(), dto.code());
    }

    private ConnectionTypeReference connectionTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(CONNECTION_TYPE, code, locale);
        return ConnectionTypeReference.of(dto.id(), dto.code());
    }

    private ConnectionTypeReference optionalConnectionType(String code, String locale) {
        if (blank(code)) {
            return null;
        }
        TopologyCatalogDto dto = resolveForRead(CONNECTION_TYPE, code, locale);
        return ConnectionTypeReference.of(dto.id(), dto.code());
    }

    private EquipmentTypeReference equipmentTypeReferenceForCreation(String code, String locale) {
        TopologyCatalogDto dto = resolveForCreation(EQUIPMENT_TYPE, code, locale);
        return EquipmentTypeReference.of(dto.id(), dto.code());
    }

    private TopologyTypeReferenceResponse toTypeResponse(String catalogName, String code, String locale) {
        TopologyCatalogDto dto = resolveForRead(catalogName, code, locale);
        return new TopologyTypeReferenceResponse(dto.id(), dto.code(), dto.localizedName(), dto.locale());
    }

    private TopologyTypeReferenceResponse toOptionalTypeResponse(String catalogName, String code, String locale) {
        if (blank(code)) {
            return null;
        }
        return toTypeResponse(catalogName, code, locale);
    }

    private TopologyCatalogDto resolveForCreation(String catalogName, String code, String locale) {
        return resolveCatalogType(ResolveTopologyCatalogTypeQuery.forCreation(catalogName, TopologyCode.of(code), locale));
    }

    private TopologyCatalogDto resolveForRead(String catalogName, String code, String locale) {
        return resolveCatalogType(ResolveTopologyCatalogTypeQuery.forRead(catalogName, TopologyCode.of(code), locale));
    }
