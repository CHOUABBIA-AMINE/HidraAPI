 ...
 *
 * @Name        : RejectWorkflowTaskRequest
 ...
 *
 * @Description : REST request DTO for rejecting workflow tasks.
 *
 */
package dz.sh.hidra.modules.workflow.api.rest.request;
...
/**
 * REST request DTO for rejecting workflow tasks.
 *
 * <p>Architecture role:
 ...
 */
public record RejectWorkflowTaskRequest(
        @Valid
        @NotNull
        ...
        @Valid
        @NotNull
        @Schema(description = "Rejection reason catalog reference")
