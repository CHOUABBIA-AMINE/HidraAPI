 ...
 *
 * @Name        : ActivateTelemetryPointCommand
 ...
 *
 * @Description : Command to activate a telemetry point.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to activate a telemetry point.
 *
 * <p>Architecture role:
 ...
 */
public record ActivateTelemetryPointCommand(
        TelemetryDeviceId deviceId,
        TelemetryPointId pointId) implements Command {

    public ActivateTelemetryPointCommand {
        pointId = Objects.requireNonNull(pointId, "ActivateTelemetryPointCommand pointId must not be null.");
    }
}
