 ...
 *
 * @Description : Inbound use-case port for creating an identity role.
 *
 */
    package dz.sh.hidra.modules.identity.application.port.in;
...
import dz.sh.hidra.modules.identity.application.dto.RoleDto;
    ...
    /**
     * Inbound use-case port for creating an identity role.
     *
     * <p>Business role: exposes the application boundary for creating an identity role in the identity
     * module.</p>
     *
