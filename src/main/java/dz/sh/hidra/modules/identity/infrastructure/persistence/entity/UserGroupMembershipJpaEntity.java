 ...
 *
 * @Description : Framework-neutral persistence shape for UserGroupMembership.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for UserGroupMembership.
 *
 ...
 */
public record UserGroupMembershipJpaEntity(
        String id,
        String payload
) {
}
