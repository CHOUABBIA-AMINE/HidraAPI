 ...
 *
 * @Name        : ActivateTelemetrySourceCommand
 ...
 *
 * @Description : Command to activate a telemetry source.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
 ...
 */
public record ActivateTelemetrySourceCommand(
        TelemetrySourceId sourceId) implements Command {

    public ActivateTelemetrySourceCommand {
    }
}
