 ...
 *
 * @Name        : ListTelemetryIngestionBatchesQuery
 ...
 *
 * @Description : Query to list telemetry ingestion batches.
 *
 */
package dz.sh.hidra.modules.telemetry.application.query;
...
/**
 * Query to list telemetry ingestion batches.
 *
 * <p>Architecture role:
 ...
 */
public record ListTelemetryIngestionBatchesQuery(
    ...
    public ListTelemetryIngestionBatchesQuery {
        pageRequest = Objects.requireNonNull(pageRequest, "ListTelemetryIngestionBatchesQuery pageRequest must not be null.");
    }
}
