 ...
 *
 * @Description : Framework-neutral persistence shape for ExternalRoleMapping.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for ExternalRoleMapping.
 *
 ...
 */
public record ExternalRoleMappingJpaEntity(
        String id,
        String payload
) {
}
