 ...
 *
 * @Name        : GetTelemetryIngestionBatchUseCase
 ...
 *
 * @Description : Inbound port for retrieving one telemetry ingestion batch.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retrieving one telemetry ingestion batch.
 *
 * <p>Architecture role:
 ...
 */
public interface GetTelemetryIngestionBatchUseCase {
     ...
     */
    TelemetryIngestionBatchDto getTelemetryIngestionBatch(GetTelemetryIngestionBatchByIdQuery query);
}
