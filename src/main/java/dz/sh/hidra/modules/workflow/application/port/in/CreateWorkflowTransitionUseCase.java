 ...
 *
 * @Name        : CreateWorkflowTransitionUseCase
 ...
 *
 * @Description : Inbound port for creating workflow definition transitions.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for creating workflow definition transitions.
 *
 * <p>Architecture role:
 ...
 */
public interface CreateWorkflowTransitionUseCase {
     ...
     */
    WorkflowDefinitionDto createWorkflowTransition(CreateWorkflowTransitionCommand command);
}
