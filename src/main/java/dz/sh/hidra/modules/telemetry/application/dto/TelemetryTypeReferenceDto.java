 ...
 *
 * @Name        : TelemetryTypeReferenceDto
 ...
 *
 * @Description : Application DTO for localized telemetry catalog references.
 *
 */
package dz.sh.hidra.modules.telemetry.application.dto;

/**
 * Application DTO for localized telemetry catalog references.
 *
 * <p>Architecture role:
 ...
 */
public record TelemetryTypeReferenceDto(
        String id,
        String code,
        String label,
        String locale) {

    public TelemetryTypeReferenceDto {
    }
}
