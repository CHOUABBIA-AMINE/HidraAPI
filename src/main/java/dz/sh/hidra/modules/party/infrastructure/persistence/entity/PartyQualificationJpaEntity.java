 ...
 *
 * @Name        : PartyQualificationJpaEntity
 ...
 *
 * @Description : Database-backed JPA entity for PartyQualification.
 *
 */
package dz.sh.hidra.modules.party.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for PartyQualification.
     */
    @Entity
    @Table(name = "hidra_party_qualification")
    public class PartyQualificationJpaEntity {
    ...
    @Column(name = "qualification_type_code", nullable = false, length = 120)
    ...
    private Instant updatedAt;
        ...
        protected PartyQualificationJpaEntity() {
            // Required by JPA.
        }

        public PartyQualificationJpaEntity(
                String id,
            String partyId,
    ...
    public String qualificationTypeCode() {
