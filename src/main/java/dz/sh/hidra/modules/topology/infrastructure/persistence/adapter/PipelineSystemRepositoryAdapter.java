 ...
 *
 * <p>Business role:
 * Persists and retrieves topology pipelineSystem domain models through Spring Data JPA.
 *
 * <p>Architecture role:
...
public final class PipelineSystemRepositoryAdapter implements PipelineSystemRepositoryPort {
    ...
    public PipelineSystemRepositoryAdapter(
            PipelineSystemJpaRepository jpaRepository,
