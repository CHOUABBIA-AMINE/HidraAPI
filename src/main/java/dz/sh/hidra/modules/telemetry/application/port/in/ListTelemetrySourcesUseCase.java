 ...
 *
 * @Name        : ListTelemetrySourcesUseCase
 ...
 *
 * @Description : Inbound port for listing telemetry sources.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for listing telemetry sources.
 *
 * <p>Architecture role:
 ...
 */
public interface ListTelemetrySourcesUseCase {
     ...
     */
    TelemetryPageDto<TelemetrySourceDto> listTelemetrySources(ListTelemetrySourcesQuery query);
}
