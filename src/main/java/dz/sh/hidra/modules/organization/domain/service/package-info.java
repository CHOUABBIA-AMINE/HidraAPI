 ...
 *
 * @Description : Organization domain service boundary.
 *
 */

/**
 * Domain service package for coordinating rules that span multiple organization domain objects.
 *
 * <p>What belongs here:
 * Domain services for employee assignment, hierarchy validation, and reporting-line validation.
 *
 * <p>What is forbidden here:
 * Application orchestration, persistence adapters, REST controllers, and platform infrastructure logic.
 *
 * <p>Boundary rules:
