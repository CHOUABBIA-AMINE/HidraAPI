 ...
 *
 * @Name        : CreateTopologyConnectionUseCase
 ...
 *
 * @Description : Inbound port for a topology connection creation.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for a topology connection creation.
 *
 * <p>Business role:
 ...
 */
public interface CreateTopologyConnectionUseCase {

    /**
     * Creates a topology connection.
     *
     * @param command use-case input
     * @return created a topology connection DTO
     */
    TopologyConnectionDto createTopologyConnection(CreateTopologyConnectionCommand command);
}
