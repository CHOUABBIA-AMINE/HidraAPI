 ...
 *
 * @Description : Application DTO for workflow type catalog references.
 *
 */
package dz.sh.hidra.modules.workflow.application.dto;

/**
 * Application DTO for workflow type catalog references.
 *
 * <p>Architecture role:
 ...
 * or notification.
 */
public record WorkflowTypeReferenceDto(
        String id,
        String code,
        String label,
        String locale) {

    public WorkflowTypeReferenceDto {
    }
}
