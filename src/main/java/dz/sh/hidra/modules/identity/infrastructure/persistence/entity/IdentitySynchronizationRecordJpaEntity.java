 ...
 *
 * @Description : Framework-neutral persistence shape for IdentitySynchronizationRecord.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for IdentitySynchronizationRecord.
 *
 ...
 */
public record IdentitySynchronizationRecordJpaEntity(
        String id,
        String payload
) {
}
