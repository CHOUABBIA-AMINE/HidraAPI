 ...
 *
 * @Name        : RetireTelemetryPointCommand
 ...
 *
 * @Description : Command to retire a telemetry point.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to retire a telemetry point.
 *
 * <p>Architecture role:
 ...
 */
public record RetireTelemetryPointCommand(
        TelemetryPointId pointId) implements Command {

    public RetireTelemetryPointCommand {
        pointId = Objects.requireNonNull(pointId, "RetireTelemetryPointCommand pointId must not be null.");
    }
}
