 ...
 *
 * @Name        : GetLatestTelemetryReadingQuery
 ...
 *
 * @Description : Query to get the latest telemetry reading for a point.
 *
 */
package dz.sh.hidra.modules.telemetry.application.query;
...
/**
 * Query to get the latest telemetry reading for a point.
 *
 * <p>Architecture role:
 ...
 */
public record GetLatestTelemetryReadingQuery(
        TelemetryPointId pointId) implements Query {

    public GetLatestTelemetryReadingQuery {
        pointId = Objects.requireNonNull(pointId, "GetLatestTelemetryReadingQuery pointId must not be null.");
    }
}
