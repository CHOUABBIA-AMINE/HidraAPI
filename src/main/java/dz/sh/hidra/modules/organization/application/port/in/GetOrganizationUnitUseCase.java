 ...
 *
 * @Name        : GetOrganizationUnitUseCase
 ...
 *
 * @Description : Inbound port for retrieving one organization unit.
 *
 */
package dz.sh.hidra.modules.organization.application.port.in;
...
/**
 * Inbound port for retrieving one organization unit.
 *
 * <p>Business role:
 ...
 */
public interface GetOrganizationUnitUseCase {

    /**
     * Retrieves one organization unit by identifier.
     *
     * @param query use-case input
     * @return organization unit DTO when found
     */
    Optional<OrganizationUnitDto> getOrganizationUnit(GetOrganizationUnitByIdQuery query);
}
