 ...
 *
 * @Description : Outbound persistence port for pipeline.
 *
 */
package dz.sh.hidra.modules.topology.application.port.out;
...
/**
 * Outbound persistence port for pipeline.
 *
 * <p>Business role:
...
public interface PipelineRepositoryPort {
     ...
     * Saves pipeline.
     *
     * @param pipeline domain model
     * @return saved domain model
     */
    Pipeline save(Pipeline pipeline);

    /**
     * Finds pipeline by identifier.
     *
     * @param id identifier
    ...
    /**
     * Finds pipeline by business code.
     *
     * @param code business code
     * @return optional domain model
     */
    Optional<Pipeline> findByCode(TopologyCode code);

    /**
     * Checks whether pipeline exists with the supplied business code.
     *
     * @param code business code
    ...
    /**
     * Lists pipeline according to application filtering and pagination criteria.
     *
     * @param query list query
     * @return paged domain model result
     */
    PageResult<Pipeline> findAll(ListPipelinesQuery query);
