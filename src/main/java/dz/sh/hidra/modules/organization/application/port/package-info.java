 ...
 *
 * @Description : Organization application port boundary.
 *
 */

/**
 * Application port root package for organization inbound and outbound contracts.
 *
 * <p>What belongs here:
 * Subpackages for use-case input ports and dependency output ports.
 *
 * <p>What is forbidden here:
 * Concrete infrastructure adapters, controllers, JPA entities, and domain implementation details not exposed by ports.
 *
 * <p>Boundary rules:
