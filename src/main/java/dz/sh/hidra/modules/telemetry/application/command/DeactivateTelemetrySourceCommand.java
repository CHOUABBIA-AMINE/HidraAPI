 ...
 *
 * @Name        : DeactivateTelemetrySourceCommand
 ...
 *
 * @Description : Command to deactivate a telemetry source.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to deactivate a telemetry source.
 *
 * <p>Architecture role:
 ...
 */
public record DeactivateTelemetrySourceCommand(
        TelemetrySourceId sourceId) implements Command {

    public DeactivateTelemetrySourceCommand {
    }
}
