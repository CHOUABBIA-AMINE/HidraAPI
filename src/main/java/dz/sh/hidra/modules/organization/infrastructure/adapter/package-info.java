 ...
 *
 * @Description : Organization infrastructure adapter boundary.
 *
 */

/**
 * Infrastructure adapter package for non-persistence organization adapters.
 *
 * <p>What belongs here:
 * Adapters such as a no-op domain event publisher until platform outbox integration is introduced.
 *
 * <p>What is forbidden here:
 * Platform implementation ownership, security filter chains, business rules, and identity/topology implementation code.
 *
 * <p>Boundary rules:
