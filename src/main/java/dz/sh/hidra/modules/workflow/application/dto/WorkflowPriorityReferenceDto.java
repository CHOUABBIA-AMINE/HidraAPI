 ...
 *
 * @Name        : WorkflowPriorityReferenceDto
 ...
 *
 * @Description : Application DTO for workflow priority catalog references.
 *
 */
package dz.sh.hidra.modules.workflow.application.dto;

/**
 * Application DTO for workflow priority catalog references.
 *
 * <p>Architecture role:
 ...
 * or notification.
 */
public record WorkflowPriorityReferenceDto(
        String id,
        String code,
        String label,
        String locale) {

    public WorkflowPriorityReferenceDto {
    }
}
