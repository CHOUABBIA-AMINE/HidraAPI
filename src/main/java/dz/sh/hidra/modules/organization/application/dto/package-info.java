 ...
 *
 * @Description : Organization application DTO boundary.
 *
 */

/**
 * Application DTO package for stable use-case outputs.
 *
 * <p>What belongs here:
 * Immutable DTO records representing employees, organization units, positions, employee assignments, and reporting lines for application responses.
 *
 * <p>What is forbidden here:
 * REST-specific annotations, JPA entities, domain aggregates leaked as DTOs, and Swagger annotations outside the API layer.
 *
 * <p>Boundary rules:
