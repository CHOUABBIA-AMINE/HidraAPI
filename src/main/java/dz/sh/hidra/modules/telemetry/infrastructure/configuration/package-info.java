 ...
 *
 * @Description : Telemetry infrastructure configuration package boundary.
 *
 */
/**
 * Telemetry infrastructure configuration package boundary.
 *
 * <p>Responsibility:
 * This package defines telemetry infrastructure configuration package boundary.
 *
 * <p>What belongs here:
 * Spring configuration, persistence entities, repositories, mappers, and adapters owned by telemetry.
 *
 * <p>What is forbidden here:
 * domain business rules, REST endpoint contracts, application command/query definitions, or cross-module shared utilities.
 *
 * <p>Boundary rules:
