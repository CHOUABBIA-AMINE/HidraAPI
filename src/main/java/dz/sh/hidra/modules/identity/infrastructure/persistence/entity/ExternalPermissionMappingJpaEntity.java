 ...
 *
 * @Description : Framework-neutral persistence shape for ExternalPermissionMapping.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for ExternalPermissionMapping.
 *
 ...
 */
public record ExternalPermissionMappingJpaEntity(
        String id,
        String payload
) {
}
