 ...
 *
 * @Name        : GetWorkflowDefinitionUseCase
 ...
 *
 * @Description : Inbound port for retrieving workflow definitions.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for retrieving workflow definitions.
 *
 * <p>Architecture role:
 ...
 */
public interface GetWorkflowDefinitionUseCase {
     ...
     */
    WorkflowDefinitionDto getWorkflowDefinition(GetWorkflowDefinitionQuery query);
}
