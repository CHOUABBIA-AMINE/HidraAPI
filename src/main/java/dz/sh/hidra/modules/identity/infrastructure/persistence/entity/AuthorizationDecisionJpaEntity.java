 ...
 *
 * @Description : Framework-neutral persistence shape for AuthorizationDecision.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthorizationDecision.
 *
 ...
 */
public record AuthorizationDecisionJpaEntity(
        String id,
        String payload
) {
}
