 ...
 *
 * @Description : Framework-neutral persistence shape for AuthorizationPolicyVersion.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthorizationPolicyVersion.
 *
 ...
 */
public record AuthorizationPolicyVersionJpaEntity(
        String id,
        String payload
) {
}
