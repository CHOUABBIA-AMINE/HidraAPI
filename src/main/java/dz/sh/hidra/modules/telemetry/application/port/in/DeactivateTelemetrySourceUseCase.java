 ...
 *
 * @Name        : DeactivateTelemetrySourceUseCase
 ...
 *
 * @Description : Inbound port for deactivating telemetry sources.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for deactivating telemetry sources.
 *
 * <p>Architecture role:
 ...
 */
public interface DeactivateTelemetrySourceUseCase {
     ...
     */
    TelemetrySourceDto deactivateTelemetrySource(DeactivateTelemetrySourceCommand command);
}
