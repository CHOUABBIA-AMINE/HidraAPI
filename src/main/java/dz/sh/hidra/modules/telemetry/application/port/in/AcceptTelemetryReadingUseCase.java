 ...
 *
 * @Name        : AcceptTelemetryReadingUseCase
 ...
 *
 * @Description : Inbound port for accepting telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for accepting telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public interface AcceptTelemetryReadingUseCase {
     ...
     */
    TelemetryReadingDto acceptTelemetryReading(AcceptTelemetryReadingCommand command);
}
