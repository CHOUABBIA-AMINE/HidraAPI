 ...
 *
 * @Name        : RetireTelemetryPointUseCase
 ...
 *
 * @Description : Inbound port for retiring telemetry points.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retiring telemetry points.
 *
 * <p>Architecture role:
 ...
 */
public interface RetireTelemetryPointUseCase {
     ...
     */
    TelemetryPointDto retireTelemetryPoint(RetireTelemetryPointCommand command);
}
