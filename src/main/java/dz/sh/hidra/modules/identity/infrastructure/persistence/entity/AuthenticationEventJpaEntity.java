 ...
 *
 * @Description : Framework-neutral persistence shape for AuthenticationEvent.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthenticationEvent.
 *
 ...
 */
public record AuthenticationEventJpaEntity(
        String id,
        String payload
) {
}
