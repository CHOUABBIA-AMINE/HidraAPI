 ...
 *
 * @Description : Inbound port for retrieving a pipeline system.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for retrieving a pipeline system.
 *
 * <p>Business role:
 ...
 */
public interface GetPipelineSystemUseCase {

    /**
     * Retrieves a pipeline system.
     *
     * @param query use-case input
     * @return a pipeline system DTO
     */
    PipelineSystemDto getPipelineSystem(GetPipelineSystemByIdQuery query);
}
