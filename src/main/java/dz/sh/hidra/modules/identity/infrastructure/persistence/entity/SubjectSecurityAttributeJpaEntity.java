 ...
 *
 * @Description : Framework-neutral persistence shape for SubjectSecurityAttribute.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for SubjectSecurityAttribute.
 *
 ...
 */
public record SubjectSecurityAttributeJpaEntity(
        String id,
        String payload
) {
}
