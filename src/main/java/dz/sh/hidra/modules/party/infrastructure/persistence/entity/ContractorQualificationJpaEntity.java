 ...
 *
 * @Name        : ContractorQualificationJpaEntity
 ...
 *
 * @Description : Database-backed JPA entity for ContractorQualification.
 *
 */
package dz.sh.hidra.modules.party.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for ContractorQualification.
     */
    @Entity
    @Table(name = "hidra_party_contractor_qualification")
    public class ContractorQualificationJpaEntity {
    ...
    @Column(name = "contractor_category_code", nullable = false, length = 120)
    private String contractorCategoryCode;
    ...
    private Instant updatedAt;
        ...
        protected ContractorQualificationJpaEntity() {
            // Required by JPA.
        }

        public ContractorQualificationJpaEntity(
                String id,
            String partyId,
        ...
        this.contractorCategoryCode = contractorCategoryCode;
    ...
    public String contractorCategoryCode() {
        return contractorCategoryCode;
    }
