 ...
 *
 * @Name        : RejectTelemetryReadingRequest
 ...
 *
 * @Description : REST request DTO for rejecting telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.api.rest.request;
...
/**
 * REST request DTO for rejecting telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public record RejectTelemetryReadingRequest(
        @Schema(description = "Rejection reason", example = "Invalid quality flag")
        @NotBlank
        @Size(max = 500)
        String reason) {
}
