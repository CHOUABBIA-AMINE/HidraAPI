 ...
 *
 * @Name        : RetireTelemetryDeviceUseCase
 ...
 *
 * @Description : Inbound port for retiring telemetry devices.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retiring telemetry devices.
 *
 * <p>Architecture role:
 ...
 */
public interface RetireTelemetryDeviceUseCase {
     ...
     */
    TelemetryDeviceDto retireTelemetryDevice(RetireTelemetryDeviceCommand command);
}
