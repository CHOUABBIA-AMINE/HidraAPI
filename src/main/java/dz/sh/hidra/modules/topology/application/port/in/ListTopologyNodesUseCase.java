 ...
 *
 * @Description : Inbound port for listing topology nodes.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for listing topology nodes.
 *
 * <p>Business role:
 ...
 */
public interface ListTopologyNodesUseCase {

    /**
     * Lists topology nodes.
     *
     * @param query use-case input
     * @return paged topology nodes DTO result
     */
    PageResult<TopologyNodeDto> listTopologyNodes(ListTopologyNodesQuery query);
}
