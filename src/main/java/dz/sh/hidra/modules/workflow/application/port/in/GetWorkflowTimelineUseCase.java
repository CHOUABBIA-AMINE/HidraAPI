 ...
 *
 * @Name        : GetWorkflowTimelineUseCase
 ...
 *
 * @Description : Inbound port for retrieving workflow timelines.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for retrieving workflow timelines.
 *
 * <p>Architecture role:
 ...
 */
public interface GetWorkflowTimelineUseCase {
     ...
     */
    WorkflowTimelineDto getWorkflowTimeline(GetWorkflowTimelineQuery query);
}
