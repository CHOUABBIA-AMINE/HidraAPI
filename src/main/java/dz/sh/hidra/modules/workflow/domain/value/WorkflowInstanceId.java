 ...
 *
 * @Description : WorkflowInstanceId value object.
 *
 */
package dz.sh.hidra.modules.workflow.domain.value;
...
/**
 * WorkflowInstanceId value object.
 *
 * <p>Business role:
 ...
 */
public record WorkflowInstanceId(String value) implements ValueObject {
    ...
    private static String normalize(String value) {
        if (value == null || value.isBlank()) {
            throw new InvalidValueObjectException("WorkflowInstanceId must not be null or blank.");
        }

        String normalized = value.trim();

        if (normalized.length() > 80) {
            throw new InvalidValueObjectException("WorkflowInstanceId length must not exceed 80 characters.");
        }
