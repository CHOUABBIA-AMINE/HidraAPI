 ...
 *
 * @Name        : GetWorkflowCatalogTypeUseCase
 ...
 *
 * @Description : Inbound port for retrieving workflow catalog entries.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for retrieving workflow catalog entries.
 *
 * <p>Architecture role:
 ...
 */
public interface GetWorkflowCatalogTypeUseCase {
     ...
     */
    WorkflowCatalogDto getWorkflowCatalogType(GetWorkflowCatalogTypeQuery query);
}
