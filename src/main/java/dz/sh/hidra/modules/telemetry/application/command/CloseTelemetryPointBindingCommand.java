 ...
 *
 * @Name        : CloseTelemetryPointBindingCommand
 ...
 *
 * @Description : Command to close a telemetry point topology binding.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to close a telemetry point topology binding.
 *
 * <p>Architecture role:
 ...
 */
public record CloseTelemetryPointBindingCommand(
        TelemetryPointBindingId bindingId,
        java.time.Instant closedAt) implements Command {

    public CloseTelemetryPointBindingCommand {
        bindingId = Objects.requireNonNull(bindingId, "CloseTelemetryPointBindingCommand bindingId must not be null.");
    }
}
