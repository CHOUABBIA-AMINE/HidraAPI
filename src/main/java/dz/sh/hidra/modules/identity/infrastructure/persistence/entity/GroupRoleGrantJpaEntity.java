 ...
 *
 * @Description : Database-backed JPA entity for GroupRoleGrant.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for GroupRoleGrant.
     */
    @Entity
    @Table(name = "hidra_identity_group_role_grant")
    public class GroupRoleGrantJpaEntity {
    ...
    private Instant createdAt;
        ...
        protected GroupRoleGrantJpaEntity() {
            // Required by JPA.
        }

        public GroupRoleGrantJpaEntity(
                String id,
            String groupId,
            String roleId,
            ScopeType scopeType,
