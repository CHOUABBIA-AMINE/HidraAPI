 ...
 *
 * @Name        : SupplierQualificationJpaEntity
 ...
 *
 * @Description : Database-backed JPA entity for SupplierQualification.
 *
 */
package dz.sh.hidra.modules.party.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for SupplierQualification.
     */
    @Entity
    @Table(name = "hidra_party_supplier_qualification")
    public class SupplierQualificationJpaEntity {
    ...
    @Column(name = "supplier_category_code", nullable = false, length = 120)
    ...
    private Instant updatedAt;
        ...
        protected SupplierQualificationJpaEntity() {
            // Required by JPA.
        }

        public SupplierQualificationJpaEntity(
                String id,
            String partyId,
