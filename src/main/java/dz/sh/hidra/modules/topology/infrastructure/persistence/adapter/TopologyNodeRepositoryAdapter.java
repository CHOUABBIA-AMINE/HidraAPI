 ...
 *
 * <p>Business role:
 * Persists and retrieves topology topologyNode domain models through Spring Data JPA.
 *
 * <p>Architecture role:
...
public final class TopologyNodeRepositoryAdapter implements TopologyNodeRepositoryPort {
    ...
    public TopologyNodeRepositoryAdapter(
            TopologyNodeJpaRepository jpaRepository,
    ...
    public PageResult<TopologyNode> findAll(ListTopologyNodesQuery query) {
        ...
        List<TopologyNode> filteredItems = jpaRepository.findAll().stream()
                ...
                .filter(entity -> query.nodeType() == null || entity.getNodeType().equals(query.nodeType().name()))
