 ...
 *
 * @Description : Framework-neutral persistence shape for AuthorizationPolicy.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthorizationPolicy.
 *
 ...
 */
public record AuthorizationPolicyJpaEntity(
        String id,
        String payload
) {
}
