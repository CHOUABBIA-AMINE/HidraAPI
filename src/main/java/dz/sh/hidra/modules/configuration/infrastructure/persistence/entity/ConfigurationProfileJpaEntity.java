 ...
 *
 * @Name        : ConfigurationProfileJpaEntity
 ...
 *
 * @Description : Database-backed JPA entity for ConfigurationProfile.
 *
 */
package dz.sh.hidra.modules.configuration.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for ConfigurationProfile.
     */
    @Entity
    @Table(name = "hidra_configuration_profile")
    public class ConfigurationProfileJpaEntity {
    ...
    private Instant updatedAt;
        ...
        protected ConfigurationProfileJpaEntity() {
            // Required by JPA.
        }

        public ConfigurationProfileJpaEntity(
                String id,
            String code,
            String nameFr,
            String nameAr,
