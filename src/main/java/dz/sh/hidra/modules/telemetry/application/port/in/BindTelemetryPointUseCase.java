 ...
 *
 * @Name        : BindTelemetryPointUseCase
 ...
 *
 * @Description : Inbound port for binding telemetry points to topology assets.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for binding telemetry points to topology assets.
 *
 * <p>Architecture role:
 ...
 */
public interface BindTelemetryPointUseCase {
     ...
     */
    TelemetryPointBindingDto bindTelemetryPoint(BindTelemetryPointCommand command);
}
