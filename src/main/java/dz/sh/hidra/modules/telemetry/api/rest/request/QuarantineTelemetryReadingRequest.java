 ...
 *
 * @Name        : QuarantineTelemetryReadingRequest
 ...
 *
 * @Description : REST request DTO for quarantining telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.api.rest.request;
...
/**
 * REST request DTO for quarantining telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public record QuarantineTelemetryReadingRequest(
        @Schema(description = "Quarantine reason", example = "Timestamp out of expected window")
        @NotBlank
        @Size(max = 500)
        String reason) {
}
