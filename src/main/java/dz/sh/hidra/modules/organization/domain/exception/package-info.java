 ...
 *
 * @Description : Organization domain exception boundary.
 *
 */

/**
 * Domain exception package for organization business failures.
 *
 * <p>What belongs here:
 * Organization-specific exceptions for lifecycle, hierarchy, assignment, and reporting-line violations.
 *
 * <p>What is forbidden here:
 * HTTP response models, controller advice, platform exception handlers, and persistence exceptions.
 *
 * <p>Boundary rules:
