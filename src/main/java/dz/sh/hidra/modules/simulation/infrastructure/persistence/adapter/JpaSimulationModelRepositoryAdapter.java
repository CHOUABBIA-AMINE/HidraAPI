 ...
 *
 * @Name        : JpaSimulationModelRepositoryAdapter
 ...
 *
 * @Description : Database-backed adapter for SimulationModel.
 *
 */
package dz.sh.hidra.modules.simulation.infrastructure.persistence.adapter;
...
import dz.sh.hidra.modules.simulation.infrastructure.persistence.repository.SimulationModelJpaRepository;
...
/**
 * Database-backed repository adapter for SimulationModel.
 */
@Component
public class JpaSimulationModelRepositoryAdapter implements SimulationModelRepositoryPort {

    private final SimulationModelJpaRepository repository;

    public JpaSimulationModelRepositoryAdapter(SimulationModelJpaRepository repository) {
        this.repository = Objects.requireNonNull(repository, "SimulationModelJpaRepository must not be null.");
    }
