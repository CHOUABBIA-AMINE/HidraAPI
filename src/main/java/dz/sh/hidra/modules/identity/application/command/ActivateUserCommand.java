 ...
 *
 * @Description : Command record for activating an identity user.
 *
 */
package dz.sh.hidra.modules.identity.application.command;
...
/**
 * Command used to activate an identity user.
 *
 * <p>Business role: identifies the user whose lifecycle should transition to active.</p>
 *
 * <p>Architecture role: application-layer command implementing the kernel
 * {@link Command} marker without coupling to REST, persistence, platform security, or
 * organization code.</p>
 *
 * <p>Validation responsibility: rejects a missing user identifier.</p>
 *
 * <p>Usage: pass this record to the future activate-user use case.</p>
 */
public record ActivateUserCommand(UserId userId) implements Command {
