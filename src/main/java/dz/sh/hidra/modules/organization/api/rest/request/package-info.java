 ...
 *
 * @Description : Organization REST request DTO boundary.
 *
 */

/**
 * REST request DTO package for organization input contracts.
 *
 * <p>What belongs here:
 * Bean-validated request records/classes documented with JavaDoc and Swagger @Schema for creating/updating employees, organization units, positions, assignments, and reporting lines.
 *
 * <p>What is forbidden here:
 * Domain objects, persistence entities, passwords, tokens, database version fields, and topology or identity aggregates.
 *
 * <p>Boundary rules:
