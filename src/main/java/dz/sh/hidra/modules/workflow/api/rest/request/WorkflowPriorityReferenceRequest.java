 ...
 *
 * @Name        : WorkflowPriorityReferenceRequest
 ...
 *
 * @Description : REST request DTO for workflow priority catalog references.
 *
 */
package dz.sh.hidra.modules.workflow.api.rest.request;
...
/**
 * REST request DTO for workflow priority catalog references.
 *
 * <p>Architecture role:
 ...
 */
public record WorkflowPriorityReferenceRequest(
