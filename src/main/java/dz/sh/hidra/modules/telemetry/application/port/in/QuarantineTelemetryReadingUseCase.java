 ...
 *
 * @Name        : QuarantineTelemetryReadingUseCase
 ...
 *
 * @Description : Inbound port for quarantining telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for quarantining telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public interface QuarantineTelemetryReadingUseCase {
     ...
     */
    TelemetryReadingDto quarantineTelemetryReading(QuarantineTelemetryReadingCommand command);
}
