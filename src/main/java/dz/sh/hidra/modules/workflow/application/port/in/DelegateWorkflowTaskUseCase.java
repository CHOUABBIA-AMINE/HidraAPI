 ...
 *
 * @Name        : DelegateWorkflowTaskUseCase
 ...
 *
 * @Description : Inbound port for delegating workflow tasks.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for delegating workflow tasks.
 *
 * <p>Architecture role:
 ...
 */
public interface DelegateWorkflowTaskUseCase {
     ...
     */
    WorkflowTaskDto delegateWorkflowTask(DelegateWorkflowTaskCommand command);
}
