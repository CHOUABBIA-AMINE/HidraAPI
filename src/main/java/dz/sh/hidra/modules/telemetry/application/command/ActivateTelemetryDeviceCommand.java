 ...
 *
 * @Name        : ActivateTelemetryDeviceCommand
 ...
 *
 * @Description : Command to activate a telemetry device.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to activate a telemetry device.
 *
 * <p>Architecture role:
 ...
 */
public record ActivateTelemetryDeviceCommand(
        TelemetrySourceId sourceId,
        TelemetryDeviceId deviceId) implements Command {

    public ActivateTelemetryDeviceCommand {
    }
}
