 ...
 *
 * @Name        : ActivateTelemetrySourceUseCase
 ...
 *
 * @Description : Inbound port for activating telemetry sources.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for activating telemetry sources.
 *
 * <p>Architecture role:
 ...
 */
public interface ActivateTelemetrySourceUseCase {
     ...
     */
    TelemetrySourceDto activateTelemetrySource(ActivateTelemetrySourceCommand command);
}
