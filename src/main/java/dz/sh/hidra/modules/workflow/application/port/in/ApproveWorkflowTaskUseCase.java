 ...
 *
 * @Name        : ApproveWorkflowTaskUseCase
 ...
 *
 * @Description : Inbound port for approving workflow tasks.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for approving workflow tasks.
 *
 * <p>Architecture role:
 ...
 */
public interface ApproveWorkflowTaskUseCase {
     ...
     */
    WorkflowTaskDto approveWorkflowTask(ApproveWorkflowTaskCommand command);
}
