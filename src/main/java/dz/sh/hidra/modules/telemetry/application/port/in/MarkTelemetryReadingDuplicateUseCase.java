 ...
 *
 * @Name        : MarkTelemetryReadingDuplicateUseCase
 ...
 *
 * @Description : Inbound port for marking telemetry readings as duplicate.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for marking telemetry readings as duplicate.
 *
 * <p>Architecture role:
 ...
 */
public interface MarkTelemetryReadingDuplicateUseCase {
     ...
     */
    TelemetryReadingDto markTelemetryReadingDuplicate(MarkTelemetryReadingDuplicateCommand command);
}
