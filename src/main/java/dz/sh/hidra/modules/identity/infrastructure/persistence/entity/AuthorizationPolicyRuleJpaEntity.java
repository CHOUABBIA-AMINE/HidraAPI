 ...
 *
 * @Description : Framework-neutral persistence shape for AuthorizationPolicyRule.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthorizationPolicyRule.
 *
 ...
 */
public record AuthorizationPolicyRuleJpaEntity(
        String id,
        String payload
) {
}
