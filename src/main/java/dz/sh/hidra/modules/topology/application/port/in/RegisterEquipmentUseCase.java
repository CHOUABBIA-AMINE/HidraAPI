 ...
 *
 * @Description : Inbound port for topology equipment creation.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for topology equipment creation.
 *
 * <p>Business role:
...
public interface RegisterEquipmentUseCase {
    ...
    /**
     * Registers topology equipment.
     *
     * @param command use-case input
     * @return created topology equipment DTO
     */
    EquipmentDto registerEquipment(RegisterEquipmentCommand command);
}
