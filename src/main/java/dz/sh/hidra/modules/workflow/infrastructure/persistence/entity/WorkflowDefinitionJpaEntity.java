 ...
 *
 * @Name        : WorkflowDefinitionJpaEntity
 ...
 *
 * @Description : Database-backed JPA entity for WorkflowDefinition.
 *
 */
package dz.sh.hidra.modules.workflow.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for WorkflowDefinition.
     */
    @Entity
    @Table(name = "hidra_workflow_definition")
    ...
    private Instant updatedAt;
        ...
        public WorkflowDefinitionJpaEntity(
                String id,
            String code,
            String nameAr,
            String nameFr,
