 ...
 *
 * @Description : Framework-neutral persistence shape for ExternalGroupMapping.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for ExternalGroupMapping.
 *
 ...
 */
public record ExternalGroupMappingJpaEntity(
        String id,
        String payload
) {
}
