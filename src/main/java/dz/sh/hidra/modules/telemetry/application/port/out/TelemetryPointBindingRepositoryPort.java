 ...
 *
 * @Description : Repository port for TelemetryPointBinding.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.out;
...
/**
 * Repository port for TelemetryPointBinding.
 */
public interface TelemetryPointBindingRepositoryPort {

    TelemetryPointBinding save(TelemetryPointBinding model);

    Optional<TelemetryPointBinding> findById(String id);
}
