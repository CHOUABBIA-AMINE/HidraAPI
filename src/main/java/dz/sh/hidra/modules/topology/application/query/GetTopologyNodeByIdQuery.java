 ...
 *
 * @Description : Application query for retrieving a topology node.
 *
 */
package dz.sh.hidra.modules.topology.application.query;
...
/**
 * Carries input required to retrieve a topology node.
 *
 * <p>Business role:
 ...
 *
 * @param id topology node id
 */
public record GetTopologyNodeByIdQuery(TopologyNodeId id) implements Query {

    public GetTopologyNodeByIdQuery {
        Objects.requireNonNull(id, "Topology node id must not be null.");
    }
}
