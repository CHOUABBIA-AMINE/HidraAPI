 ...
 *
 * @Description : Inbound use-case port for activating an identity user.
 *
 */
    package dz.sh.hidra.modules.identity.application.port.in;
...
import dz.sh.hidra.modules.identity.application.dto.UserDto;
    ...
    /**
     * Inbound use-case port for activating an identity user.
     *
     * <p>Business role: exposes the application boundary for activating an identity user in the identity
     * module.</p>
     *
    ...
    public interface ActivateUserUseCase {
        ...
        UserDto activate(ActivateUserCommand command);
    }
