 ...
 *
 * @Name        : RetireTelemetrySourceUseCase
 ...
 *
 * @Description : Inbound port for retiring telemetry sources.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retiring telemetry sources.
 *
 * <p>Architecture role:
 ...
 */
public interface RetireTelemetrySourceUseCase {
     ...
     */
    TelemetrySourceDto retireTelemetrySource(RetireTelemetrySourceCommand command);
}
