 ...
 *
 * @Description : Framework-neutral persistence shape for IdentitySynchronizationJob.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for IdentitySynchronizationJob.
 *
 ...
 */
public record IdentitySynchronizationJobJpaEntity(
        String id,
        String payload
) {
}
