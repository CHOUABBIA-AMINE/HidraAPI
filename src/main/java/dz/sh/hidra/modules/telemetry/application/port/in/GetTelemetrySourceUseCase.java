 ...
 *
 * @Name        : GetTelemetrySourceUseCase
 ...
 *
 * @Description : Inbound port for retrieving one telemetry source.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retrieving one telemetry source.
 *
 * <p>Architecture role:
 ...
 */
public interface GetTelemetrySourceUseCase {
     ...
     */
    TelemetrySourceDto getTelemetrySource(GetTelemetrySourceByIdQuery query);
}
