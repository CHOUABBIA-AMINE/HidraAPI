 ...
 *
 * @Name        : ListTelemetryReadingsUseCase
 ...
 *
 * @Description : Inbound port for listing telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for listing telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public interface ListTelemetryReadingsUseCase {
     ...
     */
    TelemetryPageDto<TelemetryReadingDto> listTelemetryReadings(ListTelemetryReadingsQuery query);
}
