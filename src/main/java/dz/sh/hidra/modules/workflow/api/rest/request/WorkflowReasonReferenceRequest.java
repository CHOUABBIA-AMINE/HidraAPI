 ...
 *
 * @Name        : WorkflowReasonReferenceRequest
 ...
 *
 * @Description : REST request DTO for workflow reason catalog references.
 *
 */
package dz.sh.hidra.modules.workflow.api.rest.request;
...
/**
 * REST request DTO for workflow reason catalog references.
 *
 * <p>Architecture role:
 ...
 */
public record WorkflowReasonReferenceRequest(
