 ...
 *
 * @Description : Inbound port for listing workflow tasks.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for listing workflow tasks.
 *
 * <p>Architecture role:
 ...
 */
public interface ListWorkflowTasksUseCase {
     ...
     */
    PageResult<WorkflowTaskDto> listWorkflowTasks(ListWorkflowTasksQuery query);
}
