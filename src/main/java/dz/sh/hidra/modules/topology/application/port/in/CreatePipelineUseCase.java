 ...
 *
 * @Description : Inbound port for a pipeline creation.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for a pipeline creation.
 *
 * <p>Business role:
...
public interface CreatePipelineUseCase {
     ...
     * @return created a pipeline DTO
     */
    PipelineDto createPipeline(CreatePipelineCommand command);
}
