 ...
 *
 * @Description : Inbound port for listing pipelines.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for listing pipelines.
 *
 * <p>Business role:
 ...
 */
public interface ListPipelinesUseCase {

    /**
     * Lists pipelines.
     *
     * @param query use-case input
     * @return paged pipelines DTO result
     */
    PageResult<PipelineDto> listPipelines(ListPipelinesQuery query);
}
