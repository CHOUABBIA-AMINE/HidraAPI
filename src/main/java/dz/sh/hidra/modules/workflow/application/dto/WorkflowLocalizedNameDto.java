 ...
 *
 * @Description : Application DTO for multilingual workflow names.
 *
 */
package dz.sh.hidra.modules.workflow.application.dto;

/**
 * Application DTO for multilingual workflow names.
 *
 * <p>Architecture role:
 ...
 * or notification.
 */
public record WorkflowLocalizedNameDto(
        String nameAr,
        String nameFr,
        String nameEn) {

    public WorkflowLocalizedNameDto {
    }
}
