 ...
 *
 * @Name        : ReceiveTelemetryReadingUseCase
 ...
 *
 * @Description : Inbound port for receiving raw telemetry readings.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for receiving raw telemetry readings.
 *
 * <p>Architecture role:
 ...
 */
public interface ReceiveTelemetryReadingUseCase {
     ...
     */
    TelemetryReadingDto receiveTelemetryReading(ReceiveTelemetryReadingCommand command);
}
