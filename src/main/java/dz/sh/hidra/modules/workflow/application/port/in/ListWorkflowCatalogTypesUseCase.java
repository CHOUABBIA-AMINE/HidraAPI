 ...
 *
 * @Name        : ListWorkflowCatalogTypesUseCase
 ...
 *
 * @Description : Inbound port for listing workflow catalog entries.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for listing workflow catalog entries.
 *
 * <p>Architecture role:
 ...
 */
public interface ListWorkflowCatalogTypesUseCase {
     ...
     */
    PageResult<WorkflowCatalogDto> listWorkflowCatalogTypes(ListWorkflowCatalogTypesQuery query);
}
