 ...
 *
 * @Name        : SuspendTelemetryPointUseCase
 ...
 *
 * @Description : Inbound port for suspending telemetry points.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for suspending telemetry points.
 *
 * <p>Architecture role:
 ...
 */
public interface SuspendTelemetryPointUseCase {
     ...
     */
    TelemetryPointDto suspendTelemetryPoint(SuspendTelemetryPointCommand command);
}
