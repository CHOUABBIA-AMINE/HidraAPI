 ...
 *
 * @Name        : ListTelemetryDevicesUseCase
 ...
 *
 * @Description : Inbound port for listing telemetry devices.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for listing telemetry devices.
 *
 * <p>Architecture role:
 ...
 */
public interface ListTelemetryDevicesUseCase {
     ...
     */
    TelemetryPageDto<TelemetryDeviceDto> listTelemetryDevices(ListTelemetryDevicesQuery query);
}
