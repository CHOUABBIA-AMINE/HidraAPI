 ...
 *
 * @Name        : SetEmployeeReportingLineUseCase
 ...
 *
 * @Description : Inbound port for reporting line creation or update.
 *
 */
package dz.sh.hidra.modules.organization.application.port.in;
...
/**
 * Inbound port for reporting line creation or update.
 *
 * <p>Business role:
 ...
 */
public interface SetEmployeeReportingLineUseCase {

    /**
     * Creates or updates a matrix-capable employee reporting line.
     *
     * @param command use-case input
     * @return created or updated reporting line DTO
     */
    ReportingLineDto setEmployeeReportingLine(SetEmployeeReportingLineCommand command);
}
