 ...
 *
 * @Name        : CreatePipelineSegmentUseCase
 ...
 *
 * @Description : Inbound port for a pipeline segment creation.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for a pipeline segment creation.
 *
 * <p>Business role:
 ...
 */
public interface CreatePipelineSegmentUseCase {

    /**
     * Creates a pipeline segment.
     *
     * @param command use-case input
     * @return created a pipeline segment DTO
     */
    PipelineSegmentDto createPipelineSegment(CreatePipelineSegmentCommand command);
}
