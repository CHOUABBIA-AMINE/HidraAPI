 ...
 *
 * @Name        : ListTelemetryPointsUseCase
 ...
 *
 * @Description : Inbound port for listing telemetry points.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for listing telemetry points.
 *
 * <p>Architecture role:
 ...
 */
public interface ListTelemetryPointsUseCase {
     ...
     */
    TelemetryPageDto<TelemetryPointDto> listTelemetryPoints(ListTelemetryPointsQuery query);
}
