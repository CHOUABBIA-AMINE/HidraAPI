 ...
 *
 * @Name        : TelemetryLocalizedNameDto
 ...
 *
 * @Description : Application DTO for multilingual telemetry names.
 *
 */
package dz.sh.hidra.modules.telemetry.application.dto;

/**
 * Application DTO for multilingual telemetry names.
 *
 * <p>Architecture role:
 ...
 */
public record TelemetryLocalizedNameDto(
        String nameAr,
        String nameFr,
        String nameEn) {

    public TelemetryLocalizedNameDto {
    }
}
