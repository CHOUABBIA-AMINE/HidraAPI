 ...
 *
 * @Name        : WorkflowReasonReferenceDto
 ...
 *
 * @Description : Application DTO for workflow reason catalog references.
 *
 */
package dz.sh.hidra.modules.workflow.application.dto;

/**
 * Application DTO for workflow reason catalog references.
 *
 * <p>Architecture role:
 ...
 * or notification.
 */
public record WorkflowReasonReferenceDto(
        String id,
        String code,
        String label,
        String locale) {

    public WorkflowReasonReferenceDto {
    }
}
