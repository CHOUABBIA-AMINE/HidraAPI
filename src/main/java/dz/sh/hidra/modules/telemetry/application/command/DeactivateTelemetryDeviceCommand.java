 ...
 *
 * @Name        : DeactivateTelemetryDeviceCommand
 ...
 *
 * @Description : Command to deactivate a telemetry device.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to deactivate a telemetry device.
 *
 * <p>Architecture role:
 ...
 */
public record DeactivateTelemetryDeviceCommand(
        TelemetryDeviceId deviceId) implements Command {

    public DeactivateTelemetryDeviceCommand {
    }
}
