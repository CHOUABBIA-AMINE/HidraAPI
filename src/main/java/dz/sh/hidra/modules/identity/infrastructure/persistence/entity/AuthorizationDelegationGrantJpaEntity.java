 ...
 *
 * @Description : Framework-neutral persistence shape for AuthorizationDelegationGrant.
 *
 */
package dz.sh.hidra.modules.identity.infrastructure.persistence.entity;

/**
 * Persistence shape for AuthorizationDelegationGrant.
 *
 ...
 */
public record AuthorizationDelegationGrantJpaEntity(
        String id,
        String payload
) {
}
