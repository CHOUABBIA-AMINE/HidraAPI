 ...
 *
 * @Name        : ActivateWorkflowDefinitionUseCase
 ...
 *
 * @Description : Inbound port for activating workflow definitions.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for activating workflow definitions.
 *
 * <p>Architecture role:
...
public interface ActivateWorkflowDefinitionUseCase {
     ...
     */
    WorkflowDefinitionDto activateWorkflowDefinition(ActivateWorkflowDefinitionCommand command);
}
