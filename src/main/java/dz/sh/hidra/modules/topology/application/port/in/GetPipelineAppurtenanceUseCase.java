 ...
 *
 * @Name        : GetPipelineAppurtenanceUseCase
 ...
 *
 * @Description : Inbound port for retrieving a pipeline appurtenance.
 *
 */
package dz.sh.hidra.modules.topology.application.port.in;
...
/**
 * Inbound port for retrieving a pipeline appurtenance.
 *
 * <p>Business role:
 ...
 */
public interface GetPipelineAppurtenanceUseCase {

    /**
     * Retrieves a pipeline appurtenance.
     *
     * @param query use-case input
     * @return a pipeline appurtenance DTO
     */
    PipelineAppurtenanceDto getPipelineAppurtenance(GetPipelineAppurtenanceByIdQuery query);
}
