 ...
 * @Module      : organization
 * @Package     : dz.sh.hidra.modules.organization.infrastructure
 *
 * @Description : Organization infrastructure layer boundary.
 *
 */

/**
 * Infrastructure layer for organization technical adapters.
 *
 * <p>What belongs here:
 * Persistence adapters, configuration, and temporary integration adapters implementing application outbound ports.
 *
 * <p>What is forbidden here:
 * Domain business rules, REST controllers, identity implementation code, topology implementation code, and security filter chains.
 *
 * <p>Boundary rules:
