 ...
 *
 * @Name        : CancelWorkflowInstanceCommand
 ...
 *
 * @Description : Command to cancel a workflow instance.
 *
 */
package dz.sh.hidra.modules.workflow.application.command;
 ...
 */
public record CancelWorkflowInstanceCommand(
    ...
    public CancelWorkflowInstanceCommand {
        instanceId = Objects.requireNonNull(instanceId, "CancelWorkflowInstanceCommand instanceId must not be null.");
        actor = Objects.requireNonNull(actor, "CancelWorkflowInstanceCommand actor must not be null.");
        reason = Objects.requireNonNull(reason, "CancelWorkflowInstanceCommand reason must not be null.");
    }
}
