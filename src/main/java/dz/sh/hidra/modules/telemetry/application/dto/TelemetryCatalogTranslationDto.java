 ...
 *
 * @Name        : TelemetryCatalogTranslationDto
 ...
 *
 * @Description : Application DTO for telemetry catalog translation values.
 *
 */
package dz.sh.hidra.modules.telemetry.application.dto;
...
/**
 * Application DTO for telemetry catalog translation values.
 *
 * <p>Architecture role:
 ...
 */
public record TelemetryCatalogTranslationDto(
        String id,
        String typeId,
        String locale,
        String name,
    ...
    public TelemetryCatalogTranslationDto {
    }
}
