 ...
 *
 * @Description : Application DTO for telemetry acquisition sources.
 *
 */
package dz.sh.hidra.modules.telemetry.application.dto;
...
/**
 * Application DTO for telemetry acquisition sources.
 *
 * <p>Architecture role:
...
public record TelemetrySourceDto(
        ...
        TelemetryTypeReferenceDto sourceType,
        TelemetryTypeReferenceDto protocol,
        String endpointUri,
