 ...
 * @Layer       : API
 * @Module      : telemetry
 * @Package     : dz.sh.hidra.modules.telemetry.api.rest.configuration
 *
 * @Description : Telemetry REST configuration package boundary.
 *
 */
/**
 * Telemetry REST configuration package boundary.
 *
 * <p>Responsibility:
 * This package defines telemetry REST configuration package boundary.
 *
 * <p>What belongs here:
