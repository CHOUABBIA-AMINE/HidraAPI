 ...
 *
 * @Description : Localized labels and descriptions for alarm catalog entries.
 *
 */
package dz.sh.hidra.modules.alarm.domain.model;
...
import java.time.Instant;
     ...
     */
    public record AlarmCatalogTranslation(
            String id,
        ...
        public AlarmCatalogTranslation {
        id = normalize(id);
