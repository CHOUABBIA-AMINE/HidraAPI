 ...
 *
 * @Name        : PlanningCatalogTranslation
 ...
 *
 * @Description : Multilingual labels/descriptions for planning catalog entries.
 *
 */
package dz.sh.hidra.modules.planning.domain.model;
...
import java.time.Instant;
     ...
     */
    public record PlanningCatalogTranslation(
            String id,
        ...
        public PlanningCatalogTranslation {
        id = normalize(id);
