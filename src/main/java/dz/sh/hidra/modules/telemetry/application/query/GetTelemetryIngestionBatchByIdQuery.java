 ...
 *
 * @Name        : GetTelemetryIngestionBatchByIdQuery
 ...
 *
 * @Description : Query to get a telemetry ingestion batch by identifier.
 *
 */
package dz.sh.hidra.modules.telemetry.application.query;
...
/**
 * Query to get a telemetry ingestion batch by identifier.
 *
 * <p>Architecture role:
 ...
 */
public record GetTelemetryIngestionBatchByIdQuery(
        TelemetryIngestionBatchId batchId) implements Query {

    public GetTelemetryIngestionBatchByIdQuery {
        batchId = Objects.requireNonNull(batchId, "GetTelemetryIngestionBatchByIdQuery batchId must not be null.");
    }
}
