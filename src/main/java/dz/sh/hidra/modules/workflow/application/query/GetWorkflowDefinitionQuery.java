 ...
 *
 * @Name        : GetWorkflowDefinitionQuery
 ...
 *
 * @Description : Query to get a workflow definition.
 *
 */
package dz.sh.hidra.modules.workflow.application.query;
...
/**
 * Query to get a workflow definition.
 *
 * <p>Architecture role:
...
public record GetWorkflowDefinitionQuery(
        WorkflowDefinitionId definitionId) implements Query {

    public GetWorkflowDefinitionQuery {
        definitionId = Objects.requireNonNull(definitionId, "GetWorkflowDefinitionQuery definitionId must not be null.");
    }
}
