 ...
 *
 * @Name        : ResolveWorkflowCatalogTypeUseCase
 ...
 *
 * @Description : Inbound port for resolving workflow catalog entries.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for resolving workflow catalog entries.
 *
 * <p>Architecture role:
 ...
 */
public interface ResolveWorkflowCatalogTypeUseCase {
     ...
     */
    WorkflowCatalogDto resolveWorkflowCatalogType(ResolveWorkflowCatalogTypeQuery query);
}
