 ...
 *
 * @Name        : FailTelemetryIngestionBatchRequest
 ...
 *
 * @Description : REST request DTO for failing telemetry ingestion batches.
 *
 */
package dz.sh.hidra.modules.telemetry.api.rest.request;
...
/**
 * REST request DTO for failing telemetry ingestion batches.
 *
 * <p>Architecture role:
 ...
 */
public record FailTelemetryIngestionBatchRequest(
        @Schema(description = "Failure reason", example = "Source endpoint timeout")
        @NotBlank
        @Size(max = 500)
        String reason) {
}
