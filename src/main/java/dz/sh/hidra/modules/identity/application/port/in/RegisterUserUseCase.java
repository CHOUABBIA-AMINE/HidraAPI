 ...
 *
 * @Description : Inbound use-case port for registering an identity user.
 *
 */
    package dz.sh.hidra.modules.identity.application.port.in;
...
import dz.sh.hidra.modules.identity.application.dto.UserDto;
    ...
    /**
     * Inbound use-case port for registering an identity user.
     *
     * <p>Business role: exposes the application boundary for registering an identity user in the identity
     * module.</p>
     *
