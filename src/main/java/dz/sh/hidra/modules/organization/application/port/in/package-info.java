 ...
 *
 * @Description : Organization inbound use-case port boundary.
 *
 */

/**
 * Inbound use-case port package for organization capabilities.
 *
 * <p>What belongs here:
 * Interfaces consumed by API controllers to create employees, manage units, positions, assignments, and reporting lines.
 *
 * <p>What is forbidden here:
 * REST annotations, JPA repositories, persistence adapters, and topology or identity domain imports.
 *
 * <p>Boundary rules:
