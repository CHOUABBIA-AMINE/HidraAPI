 ...
 *
 * @Description : Application DTO for workflow definitions.
 *
 */
package dz.sh.hidra.modules.workflow.application.dto;
...
/**
 * Application DTO for workflow definitions.
 *
 * <p>Architecture role:
...
public record WorkflowDefinitionDto(
        String id,
        String code,
        WorkflowLocalizedNameDto name,
        WorkflowTypeReferenceDto type,
        String status,
        int version,
