 ...
 *
 * @Description : Organization REST response DTO boundary.
 *
 */

/**
 * REST response DTO package for organization output contracts.
 *
 * <p>What belongs here:
 * Documented response records/classes with Swagger @Schema for employees, organization units, positions, assignments, and reporting lines.
 *
 * <p>What is forbidden here:
 * Domain objects, persistence entities, secrets, credentials, and internal technical auditing objects unless explicitly required.
 *
 * <p>Boundary rules:
