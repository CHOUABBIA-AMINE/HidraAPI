 ...
 *
 * @Name        : ListWorkflowInstancesUseCase
 ...
 *
 * @Description : Inbound port for listing workflow instances.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for listing workflow instances.
 *
 * <p>Architecture role:
 ...
 */
public interface ListWorkflowInstancesUseCase {
     ...
     */
    PageResult<WorkflowInstanceDto> listWorkflowInstances(ListWorkflowInstancesQuery query);
}
