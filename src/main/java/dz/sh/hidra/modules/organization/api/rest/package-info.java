 ...
 * @Layer       : API
 * @Module      : organization
 * @Package     : dz.sh.hidra.modules.organization.api.rest
 *
 * @Description : Organization REST API boundary.
 *
 */

/**
 * REST API boundary for organization endpoints under /api/v1/organization.
 *
 * <p>What belongs here:
 * REST-specific controllers, request/response DTOs, and mappers for employees, organization units, positions, assignments, and reporting lines.
 *
 * <p>What is forbidden here:
 * Application service implementation details, domain entities exposed directly to clients, JPA entities, and repository access.
 *
 * <p>Boundary rules:
