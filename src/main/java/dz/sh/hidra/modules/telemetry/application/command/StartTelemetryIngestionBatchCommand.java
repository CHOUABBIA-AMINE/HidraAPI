 ...
 *
 * @Name        : StartTelemetryIngestionBatchCommand
 ...
 *
 * @Description : Command to start a telemetry ingestion batch.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to start a telemetry ingestion batch.
 *
 * <p>Architecture role:
 ...
 */
public record StartTelemetryIngestionBatchCommand(
        TelemetrySourceId sourceId,
        TelemetryCorrelationId correlationId) implements Command {

    public StartTelemetryIngestionBatchCommand {
        sourceId = Objects.requireNonNull(sourceId, "StartTelemetryIngestionBatchCommand sourceId must not be null.");
    }
}
