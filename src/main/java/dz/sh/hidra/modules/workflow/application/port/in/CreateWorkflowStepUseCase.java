 ...
 *
 * @Name        : CreateWorkflowStepUseCase
 ...
 *
 * @Description : Inbound port for creating workflow definition steps.
 *
 */
package dz.sh.hidra.modules.workflow.application.port.in;
...
/**
 * Inbound port for creating workflow definition steps.
 *
 * <p>Architecture role:
 ...
 */
public interface CreateWorkflowStepUseCase {
     ...
     */
    WorkflowDefinitionDto createWorkflowStep(CreateWorkflowStepCommand command);
}
