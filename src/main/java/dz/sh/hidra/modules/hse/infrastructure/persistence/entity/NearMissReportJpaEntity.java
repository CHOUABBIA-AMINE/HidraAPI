 ...
 *
 * @Description : Database-backed JPA entity for NearMissReport.
 *
 */
package dz.sh.hidra.modules.hse.infrastructure.persistence.entity;
...
import java.time.Instant;
    ...
    /**
     * Database-backed JPA entity for NearMissReport.
     */
    @Entity
    @Table(name = "hidra_hse_near_miss_report")
    public class NearMissReportJpaEntity {
    ...
    @Column(name = "near_miss_type_id", nullable = false, length = 80)
    private String nearMissTypeId;
    ...
    @Column(name = "potential_consequence_id", nullable = true, length = 80)
    private String potentialConsequenceId;

    @Enumerated(EnumType.STRING)
    @Column(name = "potential_severity", nullable = true, length = 40)
    private HseImpactSeverity potentialSeverity;
    ...
    private Instant updatedAt;
        ...
        protected NearMissReportJpaEntity() {
            // Required by JPA.
        }

        public NearMissReportJpaEntity(
                String id,
            String reportNumber,
        ...
        this.nearMissTypeId = nearMissTypeId;
        this.title = title;
        this.description = description;
        this.potentialConsequenceId = potentialConsequenceId;
        this.potentialSeverity = potentialSeverity;
    ...
    public String nearMissTypeId() {
        return nearMissTypeId;
    }
    ...
    public String potentialConsequenceId() {
        return potentialConsequenceId;
    }


    public HseImpactSeverity potentialSeverity() {
