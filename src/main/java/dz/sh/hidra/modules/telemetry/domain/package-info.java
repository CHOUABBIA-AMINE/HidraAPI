 ...
 * @Layer       : Domain
 * @Module      : telemetry
 * @Package     : dz.sh.hidra.modules.telemetry.domain
 *
 * @Description : Telemetry domain layer boundary.
 *
 */
/**
 * Telemetry domain layer boundary.
 *
 * <p>Responsibility:
 * This package defines telemetry domain layer boundary.
 *
 * <p>What belongs here:
