 ...
 *
 * @Description : Inbound port for retrieving one telemetry point.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for retrieving one telemetry point.
 *
 * <p>Architecture role:
 ...
 */
public interface GetTelemetryPointUseCase {
     ...
     */
    TelemetryPointDto getTelemetryPoint(GetTelemetryPointByIdQuery query);
}
