 ...
 *
 * @Name        : SuspendTelemetryPointCommand
 ...
 *
 * @Description : Command to suspend a telemetry point.
 *
 */
package dz.sh.hidra.modules.telemetry.application.command;
...
/**
 * Command to suspend a telemetry point.
 *
 * <p>Architecture role:
 ...
 */
public record SuspendTelemetryPointCommand(
        TelemetryPointId pointId) implements Command {

    public SuspendTelemetryPointCommand {
        pointId = Objects.requireNonNull(pointId, "SuspendTelemetryPointCommand pointId must not be null.");
    }
}
