 ...
 *
 * @Description : Organization command package boundary.
 *
 */

/**
 * Command package for organization state-changing use-case input.
 *
 * <p>What belongs here:
 * Immutable command records for creating/updating employees, units, positions, assignments, and reporting lines.
 *
 * <p>What is forbidden here:
 * REST request DTOs, JPA annotations, controller logic, and domain aggregate implementation.
 *
 * <p>Boundary rules:
