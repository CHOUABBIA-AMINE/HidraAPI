 ...
 * @Layer       : Application
 * @Module      : telemetry
 * @Package     : dz.sh.hidra.modules.telemetry.application
 *
 * @Description : Telemetry application layer boundary.
 *
 */
/**
 * Telemetry application layer boundary.
 *
 * <p>Responsibility:
 * This package defines telemetry application layer boundary.
 *
 * <p>What belongs here:
