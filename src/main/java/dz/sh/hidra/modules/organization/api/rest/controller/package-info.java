 ...
 *
 * @Description : Organization REST controller boundary.
 *
 */

/**
 * REST controller package for organization HTTP endpoints.
 *
 * <p>What belongs here:
 * Controllers that depend only on application inbound ports and expose employee, organization unit, position, assignment, and reporting-line capabilities.
 *
 * <p>What is forbidden here:
 * Business rules, repository access, JPA entities, topology asset management, identity implementation code, and SupervisorAssignment.
 *
 * <p>Boundary rules:
