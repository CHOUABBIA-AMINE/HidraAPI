 ...
 *
 * @Description : Query to get a workflow instance timeline.
 *
 */
package dz.sh.hidra.modules.workflow.application.query;
...
/**
 * Query to get a workflow instance timeline.
 *
 * <p>Architecture role:
 ...
 */
public record GetWorkflowTimelineQuery(
        WorkflowInstanceId instanceId) implements Query {

    public GetWorkflowTimelineQuery {
        instanceId = Objects.requireNonNull(instanceId, "GetWorkflowTimelineQuery instanceId must not be null.");
    }
}
