 ...
 *
 * @Description : Organization application mapper boundary.
 *
 */

/**
 * Application mapper package for converting domain objects to application DTOs.
 *
 * <p>What belongs here:
 * Mapping code between domain models and application DTO records.
 *
 * <p>What is forbidden here:
 * REST mapping, persistence mapping, repository access, and business rule enforcement.
 *
 * <p>Boundary rules:
