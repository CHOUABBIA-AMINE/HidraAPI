 ...
 *
 * @Name        : ListTelemetryIngestionBatchesUseCase
 ...
 *
 * @Description : Inbound port for listing telemetry ingestion batches.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for listing telemetry ingestion batches.
 *
 * <p>Architecture role:
 ...
 */
public interface ListTelemetryIngestionBatchesUseCase {
     ...
     */
    TelemetryPageDto<TelemetryIngestionBatchDto> listTelemetryIngestionBatches(ListTelemetryIngestionBatchesQuery query);
}
