 ...
 *
 * @Name        : PipelineSegmentRepositoryPort
 ...
 *
 * @Description : Outbound persistence port for pipelineSegment.
 *
 */
package dz.sh.hidra.modules.topology.application.port.out;
...
/**
 * Outbound persistence port for pipelineSegment.
 *
 * <p>Business role:
 ...
 */
public interface PipelineSegmentRepositoryPort {

    /**
     * Saves pipelineSegment.
     *
     * @param pipelineSegment domain model
     * @return saved domain model
     */
    PipelineSegment save(PipelineSegment pipelineSegment);

    /**
     * Finds pipelineSegment by identifier.
     *
     * @param id identifier
     * @return optional domain model
     */
    Optional<PipelineSegment> findById(PipelineSegmentId id);

    /**
     * Finds pipelineSegment by business code.
     *
     * @param code business code
     * @return optional domain model
     */
    Optional<PipelineSegment> findByCode(TopologyCode code);

    /**
     * Checks whether pipelineSegment exists with the supplied business code.
     *
     * @param code business code
    ...
    /**
     * Lists pipelineSegment according to application filtering and pagination criteria.
     *
     * @param query list query
     * @return paged domain model result
     */
    PageResult<PipelineSegment> findAll(ListPipelineSegmentsQuery query);
