 ...
 *
 * @Description : Application DTO for telemetry points.
 *
 */
package dz.sh.hidra.modules.telemetry.application.dto;
...
/**
 * Application DTO for telemetry points.
 *
 * <p>Architecture role:
...
public record TelemetryPointDto(
        ...
        TelemetryTypeReferenceDto pointType,
        TelemetryTypeReferenceDto signalType,
        TelemetryTypeReferenceDto unit,
        TelemetryTypeReferenceDto defaultAggregationMethod,
