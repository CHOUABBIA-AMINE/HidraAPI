 ...
 *
 * @Name        : StartTelemetryIngestionBatchUseCase
 ...
 *
 * @Description : Inbound port for starting telemetry ingestion batches.
 *
 */
package dz.sh.hidra.modules.telemetry.application.port.in;
...
/**
 * Inbound port for starting telemetry ingestion batches.
 *
 * <p>Architecture role:
 ...
 */
public interface StartTelemetryIngestionBatchUseCase {
     ...
     */
    TelemetryIngestionBatchDto startTelemetryIngestionBatch(StartTelemetryIngestionBatchCommand command);
}
