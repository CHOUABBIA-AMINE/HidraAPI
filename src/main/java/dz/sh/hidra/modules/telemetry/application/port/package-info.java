 ...
 * @Layer       : Application
 * @Module      : telemetry
 * @Package     : dz.sh.hidra.modules.telemetry.application.port
 *
 * @Description : Telemetry application port package boundary.
 *
 */
/**
 * Telemetry application port package boundary.
 *
 * <p>Responsibility:
 * This package defines telemetry application port package boundary.
 *
 * <p>What belongs here:
